...
(function () {
  ...
  var RU = {
    ...
    'svc.valve':     'ремонт клапанов',
    'svc.engine':    'ремонт двигателя',
    'svc.apu':       'диагностика и ремонт APU',
    'svc.computer':  'компьютерная диагностика',
    'svc.def':       'ремонт DEF',
    'svc.cooling':   'ремонт систем охлаждения',
    'svc.ac':        'ремонт систем кондиционирования (A/C)',
    'svc.fuel':      'ремонт топливной системы',
    'svc.clutch':    'замена сцепления',
    'svc.other':     'другое',

    // подвал
    'footer.tagline':    'Ремонт траков, пикапов и трейлеров',
    'footer.tagline2':   'в Лос-Анджелесе, г. Коммерс, Калифорния',
    'footer.weAre':      'Мы',
